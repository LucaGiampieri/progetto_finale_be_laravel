...
@section('title', $monsterSize->name)
                        ...
                        <div class="d-flex flex-wrap gap-3 justify-content-between mb-5">
                            ...
                            <div>
                                <a class="btn btn-outline-warning px-4"
                                    href="{{ route('monsterSizes.edit', $monsterSize) }}">
                                    Modifica
                                </a>
                            ...
                            <div>
                                <a class="btn btn-outline-primary px-4" href="{{ route('monsterSizes.index') }}">
                                    Torna alle taglie
                                </a>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    ...
                    <strong>{{ $monsterSize->name }}</strong>?
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('monsterSizes.destroy', $monsterSize) }}" method="POST">
